...
function renderFooter() {
    ...
    // Guard clause: if the footer placeholder doesn't exist, stop.
    if (!footer) return;

    // 2-10. Build the HTML structure and Insert Footer HTML Content
    footer.innerHTML = `
    <footer class="footer">
...
// 11. Call the renderFooter function to populate the footer in the page
renderFooter();
